...
G3D-RPi-Programs-T800-Release-master.zip in the root of flash drive.
...
/home/user/G3D-RPi-Programs/build/G3D-RPi-Programs 
...
# Variable constants.
TARGET_FILE_NAME = "G3D-RPi-Programs-T800-Release-master.zip"
TARGET_FOLDER_NAME = "G3D-RPi-Programs-T800-Release-master"
...
PROGRAM_EXECUTABLE = os.path.join(HOME_DIR, TARGET_FOLDER_NAME, "build", "G3D-RPi-Programs")
CURRENT_PROFRAM_CONFIG_PATH = os.path.join(CURRENT_PROGRAM_DIR, "build", "resources", "g3d_rpi_programs.config")
...
print("[DEBUG]", "CURRENT_PROFRAM_CONFIG_PATH:" , CURRENT_PROFRAM_CONFIG_PATH)
    ...
    def check_extract_update(self):
        ...
        for dir_to_scan in os.listdir(USB_MOUNT_DIR):
            ...
            if TARGET_FILE_NAME in os.listdir(dir_to_scan_full_path):
                ...
                # /media/username/usbname/G3D-RPi-Programs-Release-T800-master.zip
                global ZIP_FILE_DIR
...
if __name__ == "__main__":
    ...
    # the old one in home.
    # Delete: /home/pi/G3D-RPi-Programs-Release-T800-master
    # Copy:   /home/pi/Downloads/G3D-RPi-Programs-Release-T800-master
    # to /home/pi
