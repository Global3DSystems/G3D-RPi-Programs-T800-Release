...
repo_name = "G3D-RPi-Programs-T800-Release-master"
repo_url = "https://github.com/Global3DSystems/G3D-RPi-Programs-T800-Release"
repo_readme_url = "https://raw.githubusercontent.com/Global3DSystems/G3D-RPi-Programs-T800-Release/master/build/resources/g3d_rpi_programs.config"
timeout_checking_update = 10 #10 seconds
home_dir = "/home/pi/" #os.path.expanduser("~")
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def is_connected(self):
        ...
        try:
            ...
            print("Errror in is_connected function.")
            print(str(exp))
    ...
    def get_new_version(self):
        ...
        try:
            print("Getting new version from {}".format(repo_readme_url))

            result = urllib.request.urlopen(repo_readme_url, timeout = timeout_checking_update)
    ...
    def get_current_version(self):
        ...
        try:
            ...
            current_folder = "G3D-RPi-Programs-T800-Release-master/build/resources"
