...
repo_url = "https://github.com/Global3DSystems/G3D-RPi-Programs-Release"
repo_name = "G3D-RPi-Programs-Release-master"
delay_sec = 2
...
Run on /home/pi, the folder G3D-RPi-Programs-Release-master must be in the same directory.
...
- Clone https://github.com/Global3DSystems/G3D-RPi-Programs-Release 
- Rename G3D-RPi-Programs-Release to G3D-RPi-Programs-Release-master
- Change directory G3D-RPi-Programs-Release-master
...
- Copy all contents of the G3D-RPi-Programs-Release-master to Release/G3D-RPi-Programs-Release-master.
...
if __name__ == "__main__":
    ...
    [The one located at Release/G3D-RPi-Programs-Release-master]
    > git add -A
